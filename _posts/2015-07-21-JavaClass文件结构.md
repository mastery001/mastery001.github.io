...
![Class文件格式](/images/class_file_format.jpg)
...
![class file](/images/clazz_file.jpg)
...
![常量池项目类型](/images/class_constant_type.jpg)
...
![](/images/class_constant_struct1.jpg)

![](/images/class_constant_struct2.jpg)

![](/images/class_constant_struct3.jpg)
...
![access_flags](/images/class_access_flags.jpg)
...
![field_info](/images/class_field_info.jpg)

字段修饰符放在access_flags项目中，它与类中的access_flags项目非常类似的，都是一个u2的数据类型，其中可以设置的标志
位的含义见下表：

![class_field_access_flags](/images/class_field_access_flags.jpg)
...
![](/images/class_field_descriptor.jpg)
...
![](/images/class_method_access_flags.jpg)
